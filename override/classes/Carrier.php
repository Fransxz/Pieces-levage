...
require_once(_PS_MODULE_DIR_ . 'mbeshipping/src/helper/DataHelper.php');
require_once(_PS_MODULE_DIR_ . 'mbeshipping/src/helper/RatesHelper.php');

class Carrier extends CarrierCore
{
    /*
    * module: mbeshipping
    * date: 2023-09-25 16:43:20
    * version: 2.0.8
    */
