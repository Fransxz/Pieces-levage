...
class MPServer {
    ...
    function run() {
        ...
        if (!$this->_checkToken()) {
            $this->response->error('The connector module generated for [[[[[[old_domain]]]]]]]! Please, re-download connector module and install to the (old) source PrestaShop and try connection again.', null);
            return;  
        }
