...
define('MP_TOKEN', "12252ee34c7571376c97d03786abdd56");
...
class MPServer {
    ...
    function run() {
        ...
        if (!$this->_checkToken()) {
            $this->response->error('The connector module generated for welcomefamily.us! Please, re-download connector module and install to the (old) source PrestaShop and try connection again.', null);
            return;  
        }
