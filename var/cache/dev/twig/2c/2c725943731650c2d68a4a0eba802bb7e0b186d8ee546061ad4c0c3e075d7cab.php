...
class __TwigTemplate_d0e89fc8f998e0f87a7f40c2f564c9839cf54a169530c5e1cdb75039f0139a6e extends Template
{
    private $source;
    private $macros = [];
    ...
    >
        ...
        <div class=\"header-multishop-center js-header-multishop-open-modal\">
              ...
              <g id=\"Page-1\" stroke=\"none\" stroke-width=\"1\" fill=\"none\" fill-rule=\"evenodd\" opacity=\"0.599844\">
                <g id=\"storefront-24px-(1)\" transform=\"translate(-4.000000, -6.000000)\">
                  <g id=\"Shape\">
                    <mask id=\"mask-2\" fill=\"";
                // line 44
                if ( !((isset($context["isTitleDark"]) || array_key_exists("isTitleDark", $context) ? $context["isTitleDark"] : (function () { throw new RuntimeError('Variable "isTitleDark" does not exist.', 44, $this->source); })()) === true)) {
                    echo "white";
                } else {
                    echo "#fefefe";
                }
                ...
                // line 48
                if ( !((isset($context["isTitleDark"]) || array_key_exists("isTitleDark", $context) ? $context["isTitleDark"] : (function () { throw new RuntimeError('Variable "isTitleDark" does not exist.', 48, $this->source); })()) === true)) {
                    echo "white";
                } else {
                    echo "black";
                }
          ...
          ";
                ...
                <g id=\"Page-1\" stroke=\"none\" stroke-width=\"1\" fill=\"none\" fill-rule=\"evenodd\" opacity=\"0.6\">
                    <g id=\"Group-9\">
                        <g id=\"Group-3\" transform=\"translate(19.000000, 0.000000)\">
                            <mask id=\"mask-2\" fill=\"";
                // line 61
                if ( !((isset($context["isTitleDark"]) || array_key_exists("isTitleDark", $context) ? $context["isTitleDark"] : (function () { throw new RuntimeError('Variable "isTitleDark" does not exist.', 61, $this->source); })()) === true)) {
                    echo "white";
                } else {
                    echo "black";
                }
                echo "\">
                            ...
                            <use id=\"Clip-2\" fill=\"";
                // line 64
                if ( !((isset($context["isTitleDark"]) || array_key_exists("isTitleDark", $context) ? $context["isTitleDark"] : (function () { throw new RuntimeError('Variable "isTitleDark" does not exist.', 64, $this->source); })()) === true)) {
                    echo "white";
                } else {
                    echo "black";
                }
                ...
                // line 66
                if ( !((isset($context["isTitleDark"]) || array_key_exists("isTitleDark", $context) ? $context["isTitleDark"] : (function () { throw new RuntimeError('Variable "isTitleDark" does not exist.', 66, $this->source); })()) === true)) {
                    echo "#FEFEFE";
                } else {
                    echo "black";
                }
          ...
          <h2 class=\"header-multishop-title\">
            ";
            // line 76
            if ((isset($context["isGroupContext"]) || array_key_exists("isGroupContext", $context) ? $context["isGroupContext"] : (function () { throw new RuntimeError('Variable "isGroupContext" does not exist.', 76, $this->source); })())) {
            ...
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["currentContext"]) || array_key_exists("currentContext", $context) ? $context["currentContext"] : (function () { throw new RuntimeError('Variable "currentContext" does not exist.', 76, $this->source); })()), "name", [], "any", false, false, false, 76), "html", null, true);
            echo "
          </h2>
      ...
      ";
            // line 85
            if ((isset($context["isShopContext"]) || array_key_exists("isShopContext", $context) ? $context["isShopContext"] : (function () { throw new RuntimeError('Variable "isShopContext" does not exist.', 85, $this->source); })())) {
                // line 86
                echo "        <div class=\"header-multishop-right\">
          <a class=\"header-multishop-view-action\" href=\"";
                // line 87
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["link"]) || array_key_exists("link", $context) ? $context["link"] : (function () { throw new RuntimeError('Variable "link" does not exist.', 87, $this->source); })()), "getBaseLink", [0 => twig_get_attribute($this->env, $this->source, (isset($context["currentContext"]) || array_key_exists("currentContext", $context) ? $context["currentContext"] : (function () { throw new RuntimeError('Variable "currentContext" does not exist.', 87, $this->source); })()), "id", [], "any", false, false, false, 87)], "method", false, false, false, 87), "html", null, true);
      ...
      <div id=\"multishop-modal\" class=\"multishop-modal multishop-modal-hidden js-multishop-modal\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"multishop-modal\" aria-hidden=\"true\">
        <div class=\"multishop-modal-dialog js-multishop-modal-dialog\" role=\"document\">
          <div class=\"multishop-modal-body\">
            ";
            // line 94
            if (((isset($context["lockedToAllShopContext"]) || array_key_exists("lockedToAllShopContext", $context) ? $context["lockedToAllShopContext"] : (function () { throw new RuntimeError('Variable "lockedToAllShopContext" does not exist.', 94, $this->source); })()) == false)) {
                // line 95
            ...
            <ul class=\"multishop-modal-group-list js-multishop-scrollbar\">
                <li class=\"multishop-modal-all multishop-modal-item\">
                  ";
            // line 103
            if ((isset($context["isAllShopContext"]) || array_key_exists("isAllShopContext", $context) ? $context["isAllShopContext"] : (function () { throw new RuntimeError('Variable "isAllShopContext" does not exist.', 103, $this->source); })())) {
                // line 104
            ...
            $context['_seq'] = twig_ensure_traversable(twig_array_filter($this->env, (isset($context["groupList"]) || array_key_exists("groupList", $context) ? $context["groupList"] : (function () { throw new RuntimeError('Variable "groupList" does not exist.', 113, $this->source); })()), function ($__group__) use ($context, $macros) { $context["group"] = $__group__; return  !twig_test_empty(twig_get_attribute($this->env, $this->source, $context["group"], "shops", [], "any", false, false, false, 113)); }));
            foreach ($context['_seq'] as $context["_key"] => $context["group"]) {
                // line 114
                echo "                <li class=\"multishop-modal-group-item multishop-modal-item\">
                  <span class=\"multishop-modal-color-container";
                // line 115
                if (((isset($context["isGroupContext"]) || array_key_exists("isGroupContext", $context) ? $context["isGroupContext"] : (function () { throw new RuntimeError('Variable "isGroupContext" does not exist.', 115, $this->source); })()) && (twig_get_attribute($this->env, $this->source, (isset($context["currentContext"]) || array_key_exists("currentContext", $context) ? $context["currentContext"] : (function () { throw new RuntimeError('Variable "currentContext" does not exist.', 115, $this->source); })()), "id", [], "any", false, false, false, 115) == twig_get_attribute($this->env, $this->source, $context["group"], "id", [], "any", false, false, false, 115)))) {
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["shop"]) {
                    ...
                    <span class=\"multishop-modal-color-container";
                    // line 125
                    if (((isset($context["isShopContext"]) || array_key_exists("isShopContext", $context) ? $context["isShopContext"] : (function () { throw new RuntimeError('Variable "isShopContext" does not exist.', 125, $this->source); })()) && (twig_get_attribute($this->env, $this->source, (isset($context["currentContext"]) || array_key_exists("currentContext", $context) ? $context["currentContext"] : (function () { throw new RuntimeError('Variable "currentContext" does not exist.', 125, $this->source); })()), "id", [], "any", false, false, false, 125) == twig_get_attribute($this->env, $this->source, $context["shop"], "id", [], "any", false, false, false, 125)))) {
                        echo " multishop-modal-color-check";
                    }
                    echo "\">
                      <i class=\"material-icons\">check</i>
                    ...
                    if (twig_get_attribute($this->env, $this->source, $context["shop"], "hasMainUrl", [], "method", false, false, false, 131)) {
                        ...
                        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["link"]) || array_key_exists("link", $context) ? $context["link"] : (function () { throw new RuntimeError('Variable "link" does not exist.', 132, $this->source); })()), "getBaseLink", [0 => twig_get_attribute($this->env, $this->source, $context["shop"], "id", [], "any", false, false, false, 132)], "method", false, false, false, 132), "html", null, true);
  ...
  ";
    ...
    {
        return array (  392 => 145,  384 => 139,  378 => 138,  371 => 136,  363 => 134,  355 => 132,  353 => 131,  350 => 130,  338 => 129,  325 => 127,  318 => 125,  314 => 123,  310 => 122,  302 => 119,  289 => 117,  282 => 115,  279 => 114,  275 => 113,  268 => 109,  263 => 108,  259 => 106,  255 => 104,  253 => 103,  248 => 100,  240 => 97,  236 => 95,  234 => 94,  228 => 90,  220 => 87,  217 => 86,  215 => 85,  199 => 76,  195 => 74,  180 => 66,  171 => 64,  161 => 61,  152 => 54,  139 => 48,  128 => 44,  119 => 37,  117 => 36,  108 => 34,  102 => 32,  95 => 31,  83 => 30,  70 => 29,  66 => 27,  63 => 26,  44 => 25,);
    }
