...
class __TwigTemplate_bd38b29a12a3ea41d6ac80362575cd513fd52cca1025d2cffbdaf9bd0efc8b27 extends Template
{
    private $source;
    private $macros = [];
...
";
        // line 27
        $this->env->getRuntime("Symfony\\Component\\Form\\FormRenderer")->setTheme((isset($context["pageForm"]) || array_key_exists("pageForm", $context) ? $context["pageForm"] : (function () { throw new RuntimeError('Variable "pageForm" does not exist.', 27, $this->source); })()), [0 => "@PrestaShop/Admin/TwigTemplateForm/prestashop_ui_kit.html.twig"], true);
        // line 28
        echo "
";
        // line 29
    ...
    <div class=\"card-body\">
      <div class=\"form-wrapper\">
        ";
        // line 37
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock((isset($context["pageForm"]) || array_key_exists("pageForm", $context) ? $context["pageForm"] : (function () { throw new RuntimeError('Variable "pageForm" does not exist.', 37, $this->source); })()), 'widget');
        echo "
      </div>
    </div>
...
{% endblock %}
", "@PrestaShop/Admin/Configure/ShopParameters/Blocks/product_preferences_page.html.twig", "C:\\xampp8.0\\htdocs\\pieces-levage\\src\\PrestaShopBundle\\Resources\\views\\Admin\\Configure\\ShopParameters\\Blocks\\product_preferences_page.html.twig");
    }
}
