...
class __TwigTemplate_31ae80ddb53f754bfd100570de69350ff659b5c379cb8eefd92de72b118c73f7 extends Template
{
    private $source;
    private $macros = [];
  ...
  <div class=\"card\">
    ...
    <div class=\"card-body\">
      <div class=\"form-wrapper\">
        ";
        // line 38
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock((isset($context["generalForm"]) || array_key_exists("generalForm", $context) ? $context["generalForm"] : (function () { throw new RuntimeError('Variable "generalForm" does not exist.', 38, $this->source); })()), 'widget');
        echo "
      </div>
    </div>
...
{% endblock %}
", "@PrestaShop/Admin/Configure/ShopParameters/Blocks/customer_preferences_general.html.twig", "C:\\xampp8.0\\htdocs\\pieces-levage\\src\\PrestaShopBundle\\Resources\\views\\Admin\\Configure\\ShopParameters\\Blocks\\customer_preferences_general.html.twig");
    }
}
