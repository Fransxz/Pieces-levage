...
Once you enable the "%generate_rtl_label%" option, any RTL-specific file that you might have added to your theme might be deleted by the created stylesheet.',
  ...
  array (
    ...
    'To manage the maintenance settings, go to Shop Parameters > General > Maintenance tab.' => 'To manage the maintenance settings, go to Shop Parameters > Maintenance tab.',
