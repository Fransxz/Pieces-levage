...
class FrontContainer extends \PrestaShop\PrestaShop\Adapter\Container\LegacyContainer
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $e = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($d, [0 => 'C:\\xampp8.0\\htdocs\\pieces-levage\\modules\\productcomments\\src\\Entity']);
        $e->addExcludePaths([0 => 'C:\\xampp8.0\\htdocs\\pieces-levage\\modules\\productcomments\\src\\Entity/index.php']);

        $c->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($d, [0 => 'C:\\xampp8.0\\htdocs\\pieces-levage\\src\\PrestaShopBundle\\Entity']), 'PrestaShop');
        ...
        $a->setProxyDir('C:\\xampp8.0\\htdocs\\pieces-levage/var/cache/prod\\/doctrine/orm/Proxies');
    ...
    {
        return $this->services['prestashop.adapter.module.repository.module_repository'] = new \PrestaShop\PrestaShop\Adapter\Module\Repository\ModuleRepository('C:\\xampp8.0\\htdocs\\pieces-levage', 'C:\\xampp8.0\\htdocs\\pieces-levage/modules/');
    }
    ...
    {
        return $this->services['prestashop.core.localization.cldr.cache.adapter'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('CLDR', 0, 'C:\\xampp8.0\\htdocs\\pieces-levage/var/cache/prod\\/localization');
    }
    ...
    {
        $this->services['prestashop.core.localization.cldr.datalayer.locale_cache'] = $instance = new \PrestaShop\PrestaShop\Core\Localization\CLDR\DataLayer\LocaleCache(($this->services['prestashop.core.localization.cldr.cache.adapter'] ?? ($this->services['prestashop.core.localization.cldr.cache.adapter'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('CLDR', 0, 'C:\\xampp8.0\\htdocs\\pieces-levage/var/cache/prod\\/localization'))));
    ...
    {
        return $this->services['prestashop.translation.translator_language_loader'] = new \PrestaShopBundle\Translation\TranslatorLanguageLoader(($this->services['prestashop.adapter.module.repository.module_repository'] ?? ($this->services['prestashop.adapter.module.repository.module_repository'] = new \PrestaShop\PrestaShop\Adapter\Module\Repository\ModuleRepository('C:\\xampp8.0\\htdocs\\pieces-levage', 'C:\\xampp8.0\\htdocs\\pieces-levage/modules/'))));
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.root_dir' => 'C:\\xampp8.0\\htdocs\\pieces-levage/app',
            'kernel.project_dir' => 'C:\\xampp8.0\\htdocs\\pieces-levage',
            'kernel.name' => 'app',
            'kernel.debug' => false,
            'kernel.environment' => 'prod',
            'kernel.cache_dir' => 'C:\\xampp8.0\\htdocs\\pieces-levage/var/cache/prod\\',
            ...
            'ps_cache_dir' => 'C:\\xampp8.0\\htdocs\\pieces-levage/var/cache/prod\\',
            ...
            'doctrine.orm.proxy_dir' => 'C:\\xampp8.0\\htdocs\\pieces-levage/var/cache/prod\\/doctrine/orm/Proxies',
