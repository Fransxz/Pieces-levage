    ...
    <div class="row partners-quality-wrapper">
        <div class="col-lg-12">
            ...
            <div class="footer-partners-wrapper">
                <div>
                    <img src="{_THEME_IMG_DIR_}Magsi-logo.png" class="img-responsive" alt="Magsi" style="width: 140px;">
                    <img src="{_THEME_IMG_DIR_}lodax-logo.jpeg" class="_reduce_height img-responsive" alt="lodax-logo">
                    <img src="{_THEME_IMG_DIR_}Parker.png" class="img-responsive" alt="Parker" style="width: 220px;">
                    <img src="{_THEME_IMG_DIR_}TMK-Machinery.jpg" class="_reduce_height img-responsive" alt="TMK Machinery profile">
                    <img src="{_THEME_IMG_DIR_}logo-formiko-hydraulics.png" class="img-responsive" alt="logo-formiko-hydraulics" style="width: 220px;">
                    <img src="{_THEME_IMG_DIR_}Brigade-electronics.png" class="img-responsive" alt="Brigade-electronics">
                </div>
                <div>
                    <img src="{_THEME_IMG_DIR_}Logo-GB.jpg" class="img-responsive" alt="Logo-GB" style="width: 220px;">
                    <img src="{_THEME_IMG_DIR_}indexator-logo.png" class="img-responsive" alt="indexator-logo" style="width: 220px;">
                    <img src="{_THEME_IMG_DIR_}Danfoss_Logo.png" class="img-responsive" alt="Danfoss_Logo" style="width: 220px;">
                    <img src="{_THEME_IMG_DIR_}Dalmasso.png" class="_reduce_height img-responsive" alt="Dalmasso">
                    <img src="{_THEME_IMG_DIR_}Scanreco-logo.webp" class="img-responsive" alt="Scanreco-logo" style="width: 220px;">
